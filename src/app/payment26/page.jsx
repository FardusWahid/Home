...
<div>
  <h1 className="text-3xl font-extrabold italic text-cyan-200 text-center pt-1 lg:pt-0 ">Payment Getway 2026</h1>
</div>
...
<section className="p-1 w-full flex justify-center ">
  <Image src="/h6.webp" width={700} height={700} priority={true} alt="billing"
...
<div className="mt-10 m-3 w-11/12 lg:w-5/12 xl:w-1/2 lg:mt-5">
 ...
 <p className=" font-extrabold font-mono tracking-tighter text-pink-500"><span>This course contains all the Classes, Lecture Sheets,  Practice Sheets & other Study Materials from the Original Course.</span><br /><br />
 সাথে পাবে 2025 এর Archive সম্পূর্ণ FREE.<br /><br />
...
<div className=" wd md:wdd border-4 rounded-md border-yellow-500 m-auto h-auto">
  <div className="relative overflow-hidden pb-[56.25%]"> {/* 16:9 aspect ratio */}
    <iframe
      ...
      src="https://www.youtube.com/embed/rOFXzAeyswI?si=Uu9aAliweLq-4i9g&controls=0&rel=0"
